...
const TIERS = [
  ...
  },
  {
    ...
    features: [
      "Comparative Market Analysis, as PDF and editable Word",
      "Pricing Recommendation Sheet with the comps behind it",
      "Client Neighborhood Report, ready to hand a client",
      "Buyer and Seller Net Sheet",
      "Weekly monitoring on up to 20 properties",
    ],
    addOn: "Beds, baths, days-on-market and active listings arrive with licensed MLS data.",
    href: "/for/agents",
  },
  {
    cluster: "C4",
  ...
  },
  {
    ...
    features: [
      "Investment Committee Memo, as PDF and editable Word",
      "Monday Portfolio Briefing on what changed this week",
      "Portfolio Risk Report across the book",
      "Asset One-Pager per holding",
      "Weekly monitoring on up to 500 assets",
      "Every verdict on an immutable, append-only record",
    ],
