// Cluster-aware dashboard root — tier-based access (Phase 2).
...
// limits are enforced server-side in lib/koano-guard.ts, not here. The
// approval gate (access_status / AccessPending) is retired this phase;
// AccessPending is kept for the later upgrade-screen phase. Middleware
