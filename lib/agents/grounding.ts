...
const COMMON_VOCAB = new Set<string>([
  ...
  // ordinals + briefing/summary sentence-starters and connectives
  'first','second','third','fourth','fifth','sixth','seventh','eighth','ninth','tenth','re','notes','ahead','week','weeks','confirm','confirmed','monitor','monitoring','establish','establishing','consider','prioritize','prioritise','run','rerun','baseline','watching','noting','noted','summary','warrant','warrants','flagged','pull','pulled','filed','sits','carry','carries','represents','represent','reflect','reflects','moves','moving','remains','remain','stands','shows','showing','across','portfolio','wide','live','data','separately','together','moreover','likewise','conversely','notably',
