...
This inventory is kept current. As of this writing the backend spine, all four dashboards, the archive/calibration layer, the "every verdict live" work (Phase 1), scheduled monitoring (Phase 2), and the vaporware-resolution pass (Phase 3) are all built and verified.
